#!/bin/bash
# Script to run TACO MTTKRP benchmark in Docker and show where to find results

set -e

# Configuration
IMAGE_NAME="schedgehammer-cc-artifact"
CONTAINER_NAME="schedgehammer-taco-mttkrp-benchmark-$$"
...
echo "=========================================="
echo "Schedgehammer TACO MTTKRP Benchmark"
echo "=========================================="
echo ""
echo "Configuration:"
echo "  - Runs per tuner: ${RUNS} (applies to genetic_tuner and random_tuner)"
...
echo "Running TACO MTTKRP benchmark analysis..."
echo "This may take a while depending on the budget..."
...
docker run -it --name "$CONTAINER_NAME" \
    ...
    --entrypoint examples/schedules/taco/run_taco_mttkrp_benchmark.sh \
    "$IMAGE_NAME"
EXIT_CODE=$?
...
PLOT_FILE="$RESULTS_DIR/Figure5_3_mttkrp.png"
...
echo ""
echo ""
echo "Usage: ./run_docker_taco_mttkrp_benchmark.sh"
echo ""
echo "Optional environment variables:"
echo "  RUNS - Number of runs per tuner (applies to genetic_tuner and random_tuner) (default: 1)"
