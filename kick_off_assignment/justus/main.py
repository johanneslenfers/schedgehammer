from tuning_problem import TuningProblem, TuningParameter, BooleanParameter, RealParameter, IntegerParameter, \
    OrdinalParameter, CategoricalParameter, PermutationParameter
import numpy as np

class MyTuningProblem(TuningProblem):
    ...
    def cost(self, configuration: dict[str, bool | float | int | str | list[int]]) -> float:
