#!/bin/bash
# Script to run 2DCONV benchmark in Docker and show where to find results

set -e

# Configuration
IMAGE_NAME="schedgehammer-perf"
CONTAINER_NAME="schedgehammer-2dconv-benchmark-$$"
...
echo "=========================================="
echo "Schedgehammer 2DCONV Benchmark"
echo "=========================================="
echo ""
echo "Configuration:"
...
echo "Running 2DCONV benchmark analysis..."
