#!/bin/bash
# Script to run MM benchmark in Docker and show where to find results

set -e

# Configuration
IMAGE_NAME="schedgehammer-cc-artifact"
CONTAINER_NAME="schedgehammer-mm-benchmark-$$"
...
echo "=========================================="
echo "Schedgehammer MM Benchmark"
echo "=========================================="
echo ""
echo "Configuration:"
...
echo "Running MM benchmark analysis..."
...
docker run -it --name "$CONTAINER_NAME" \
    ...
    --entrypoint examples/schedules/tvm/run_mm_benchmark.sh \
    "$IMAGE_NAME"
EXIT_CODE=$?
...
PLOT_FILE="$RESULTS_DIR/mm_benchmark_plot.png"
...
echo ""
echo ""
echo "Usage: ./run_docker_mm_benchmark.sh"
echo ""
