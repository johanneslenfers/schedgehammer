#!/bin/bash
# Script to run TACO GEMM benchmark in Docker and show where to find results

set -e

# Configuration
IMAGE_NAME="schedgehammer-cc-artifact"
CONTAINER_NAME="schedgehammer-taco-gemm-benchmark-$$"
...
echo "=========================================="
echo "Schedgehammer TACO GEMM Benchmark"
echo "=========================================="
echo ""
echo "Configuration:"
...
echo "Running TACO GEMM benchmark analysis..."
...
docker run -it --name "$CONTAINER_NAME" \
    ...
    --entrypoint examples/schedules/taco/run_taco_gemm_benchmark.sh \
    "$IMAGE_NAME"
EXIT_CODE=$?
...
PLOT_FILE="$RESULTS_DIR/taco_gemm_benchmark_plot.png"
...
echo ""
echo ""
echo "Usage: ./run_docker_taco_gemm_benchmark.sh"
echo ""
