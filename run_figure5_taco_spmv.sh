...
CONTAINER_NAME="schedgehammer-taco-spmv-benchmark-$$"
...
echo "=========================================="
echo "Schedgehammer TACO SPMV Benchmark"
echo "=========================================="
echo ""
echo "Configuration:"
...
echo "Running TACO SPMV benchmark analysis..."
...
docker run -it --name "$CONTAINER_NAME" \
    ...
    --entrypoint examples/schedules/taco/run_taco_spmv_benchmark.sh \
    "$IMAGE_NAME"
EXIT_CODE=$?
...
PLOT_FILE="$RESULTS_DIR/Figure5_2_spmv.png"
...
echo ""
echo ""
echo "Usage: ./run_docker_taco_spmv_benchmark.sh"
echo ""
